...
B) Al presionar el boton mostrar se deberan listar los pesos en gramos, en onzas y su posicion en la lista (por terminal)
...
class App(customtkinter.CTk):
    ...
    def btn_agregar_on_click(self):
        ...
        pesoTipo = self.combobox_tipo_de_peso.get()
    ...
    def btn_mostrar_on_click(self):
        ...
        for peso in self.lista_pesos:
            ...
            enOnzas = peso * 0.035274

            print("Posicion N°" + str(contador) + " | Gramos: " + str(peso) + "gr | Onzas: " + str(enOnzas) + "oz")
            contador += 1
    ...
    def btn_informar_on_click(self):
        ...
        print("Valor (en gramos) del articulo mas liviano: " + str(pesoMin) + "gr | Posicion N°" + str(posicionMin))
